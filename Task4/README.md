Предполагается что в компании команда сервисов продаж имеет полный доступ к своим сервисам, а разработчики сервисов ЖКУ только к своим

Девопс команда одна на всех имеет доступ ко всему кластеру
...
p/s для примера сделано разделение на 2 namespace, а по факту их 4 + финансы, и хранилище
